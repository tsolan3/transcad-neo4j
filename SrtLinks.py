    ...
    for rel in json_data:
        ...
        if (node1 is not None) and (node2 is not None):
            if int(rel['direction']) == 1:
                relation = Relationship(node1, 'PATH', node2, length=rel['length'], move_time=rel['move_time'],
                                        is_tram=rel['is_tram'],
                                        is_bus=rel['is_bus'],
                ...
                relation = Relationship(node2, 'PATH', node1, length=rel['length'], move_time=rel['move_time'],
                                        is_tram=rel['is_tram'],
                                        is_bus=rel['is_bus'],
                                        is_trolleybus=rel['is_trolleybus'],
                                        is_connector=rel['is_connector'],
                ...
                relation1 = Relationship(node1, 'PATH', node2, length=rel['length'], move_time=rel['move_time'],
                                         is_tram=rel['is_tram'],
                                         is_bus=rel['is_bus'],
                                         is_trolleybus=rel['is_trolleybus'],
                                         is_connector=rel['is_connector'],
                ...
                relation2 = Relationship(node2, 'PATH', node1, length=rel['length'], move_time=rel['move_time'],
                                         is_tram=rel['is_tram'],
                                         is_bus=rel['is_bus'],
                                         is_trolleybus=rel['is_trolleybus'],
                                         is_connector=rel['is_connector'],
